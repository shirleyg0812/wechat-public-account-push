...
const USER_CONFIG = {
   ...
   */
  USERS: [oGYba6cR8y4mWy6bvePdXl3ECyN8
    {
      // 想要发送的人的名字
      name: '宝宝',
      ...
      id: '',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'UWlDccJi2iYrKkTuNRLgSf2uZW1XpOtx9sVZY4KAs8U',
      // 所在省份
      province: '上海',
      // 所在城市
      city: '上海',
      ...
      openUrl: 'https://weibo.com/mbsearch?profile_ftype=1&is_all=1',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '宝宝', year: '2002', date: '08-20',
        },
        {
          type: '节日', name: '我们恋爱', year: '2022', date: '09-16',
        },
  ...
  CALLBACK_USERS: [gx030812
    {
      // 一般都填自己
      name: '自己',
      // 自己的微信id，扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'oGYba6fNOccROz16nC1UnKZUcfuA',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
